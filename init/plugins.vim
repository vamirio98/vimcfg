...
if index(g:plugin_group, 'asynctask') >= 0
	...
	nnoremap <silent> <space>amc :AsyncTask cmake-project-config<CR>
	" Build CMake project.
	nnoremap <silent> <space>amb :AsyncTask cmake-project-build<CR>
	" Run CMake project.
	nnoremap <silent> <space>amr :AsyncTask cmake-project-run<CR>
	" Clean CMake project.
	nnoremap <silent> <space>amC :AsyncTask cmake-project-clean<CR>
