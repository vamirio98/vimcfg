...
if index(g:plugin_group, 'asynctask') >= 0
	...
	nnoremap <silent> <localleader>d :AsyncTask file-debug<CR>
	...
	" run make
	nnoremap <silent> <localleader>m :AsyncTask project-build<CR>

	" run make for debugging
	nnoremap <silent> <localleader>d :AsyncTask project-debug<CR>

	" query available tasks
	nnoremap <silent> <leader>q :AsyncTaskList<CR>
endif
