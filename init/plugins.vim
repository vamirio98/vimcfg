...
if index(g:plugin_group, 'asynctask') >= 0
	...
	" Compile single file.
	nnoremap <silent> <space>asc :AsyncTask file-build<CR>
	" Run the program.
	nnoremap <silent> <space>asr :AsyncTask file-run<CR>
	" Complie single file with debug info.
	nnoremap <silent> <space>asC :AsyncTask file-debug<CR>
	" Use gdbgui to debug.
	nnoremap <silent> <space>asd :AsyncTask file-gdbgui<CR>
	...
	nnoremap <silent> <space>acc :AsyncTask cmake-project-config<CR>
	" Build CMake project.
	nnoremap <silent> <space>acb :AsyncTask cmake-project-build<CR>
	" Run CMake project.
	nnoremap <silent> <space>acr :AsyncTask cmake-project-run<CR>
	" Clean CMake project.
	nnoremap <silent> <space>acC :AsyncTask cmake-project-clean<CR>
